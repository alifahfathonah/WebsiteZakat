      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            <h2 class="mb-3 bread">Daftar Muzakki</h2>
            <p class="breadcrumbs">
              ...
              <span>Detail Muzakki <i class="ion-ios-arrow-forward"></i></span>
            </p>
          </div>
        </div>
      </div>
            ...
            <table class="table">
              ...
              <tbody>
                <?php
                    ...
                    $get_c = "SELECT * FROM customer WHERE customer_masjid='Masjid 1'";
