...
if(isset($_POST['update'])){
    ...
    $update_product = "UPDATE product SET category_id='$product_cat',product_name='$product_name',product_img_1='$product_img_1',product_img_2='$product_img_2',product_desc='$product_desc',product_price='$product_price' WHERE product_id='$p_id'";
